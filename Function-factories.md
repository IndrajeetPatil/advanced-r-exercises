...
#> <bytecode: 0x55a8da924af8>
#> <environment: 0x55a8da9241c8>
f(x)
...
#>     i
#> }
#> <bytecode: 0x55a8da0beba0>
#> <environment: 0x55a8d9ee2100>
```
...
#> 1 LL1            29µs   30.7µs    31417.    12.8KB     25.2
#> 2 LL2          15.7µs   16.5µs    57486.        0B     28.8
```
...
#>  1     10 LL1          41.4µs   46.5µs    19855.
#>  2     10 LL2          18.8µs   20.3µs    46075.
#>  3     20 LL1          43.3µs   45.5µs    21373.
#>  4     20 LL2          18.2µs   19.3µs    50317.
#>  5     50 LL1          47.1µs   49.1µs    19872.
#>  6     50 LL2          17.1µs   18.1µs    53465.
#>  7    100 LL1            62µs   64.2µs    15228.
#>  8    100 LL2          18.6µs   19.6µs    49510.
#>  9   1000 LL1         834.3µs  953.1µs     1066.
#> 10   1000 LL2          56.7µs   58.7µs    16611.
