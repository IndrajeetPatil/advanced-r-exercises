...
#> Error:
#> ! Can't withdraw more than your current balance: 120
```
...
myDeck$draw(50)
#> Error:
#> ! Can't draw more than remaining number of cards: 43
```
...
#> Ncells  700725 37.5    1373247 73.4  1373247 73.4
#> Vcells 1313275 10.1    8388608 64.0  2457947 18.8
```
