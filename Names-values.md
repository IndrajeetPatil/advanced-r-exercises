...
x[[3]] <- 4
#> tracemem[0x5619e1d66dd8 -> 0x5619e1de99c8]: eval eval withVisible withCallingHandlers eval eval with_handlers doWithOneRestart withOneRestart withRestartList doWithOneRestart withOneRestart withRestartList withRestarts <Anonymous> evaluate in_dir in_input_dir eng_r block_exec call_block process_group withCallingHandlers <Anonymous> process_file <Anonymous> <Anonymous> do.call eval eval eval eval eval.parent local 
#> tracemem[0x5619e1de99c8 -> 0x5619e1bf6a08]: eval eval withVisible withCallingHandlers eval eval with_handlers doWithOneRestart withOneRestart withRestartList doWithOneRestart withOneRestart withRestartList withRestarts <Anonymous> evaluate in_dir in_input_dir eng_r block_exec call_block process_group withCallingHandlers <Anonymous> process_file <Anonymous> <Anonymous> do.call eval eval eval eval eval.parent local
untracemem(x)
...
ref(a)
#> [1:0x5619e0d07b50] <int>

ref(b)
#> █ [1:0x5619e1e81ff8] <list> 
#> ├─[2:0x5619e0d07b50] <int> 
#> └─[2:0x5619e0d07b50]

ref(c)
#> █ [1:0x5619e2031e08] <list> 
#> ├─█ [2:0x5619e1e81ff8] <list> 
#> │ ├─[3:0x5619e0d07b50] <int> 
#> │ └─[3:0x5619e0d07b50] 
#> ├─[3:0x5619e0d07b50] 
#> └─[4:0x5619e0d64228] <int>
```
...
ref(x)
#> █ [1:0x5619e2bd2ad8] <list> 
#> ├─[2:0x5619e2b54838] <int> 
#> └─█ [3:0x5619e2b50ec8] <list> 
#>   └─[2:0x5619e2b54838]
```
...
x[[1]] <- x
#> tracemem[0x5619e25eafd8 -> 0x5619e268c118]: eval eval withVisible withCallingHandlers eval eval with_handlers doWithOneRestart withOneRestart withRestartList doWithOneRestart withOneRestart withRestartList withRestarts <Anonymous> evaluate in_dir in_input_dir eng_r block_exec call_block process_group withCallingHandlers <Anonymous> process_file <Anonymous> <Anonymous> do.call eval eval eval eval eval.parent local
