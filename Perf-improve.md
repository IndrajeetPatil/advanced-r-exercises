...
#> 1 lm         861.16µs 912.72µs     1076.    1.25MB
#> 2 speedglm     1.51ms   1.57ms      626.   72.71MB
#> 3 biglm      800.85µs 842.82µs     1149.  589.44KB
#> 4 fastLm          1ms   1.03ms      968.    4.61MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.17µs   1.24µs   739217.     2.8KB
#> 2 fastmatch    1.05µs   1.11µs   842117.    2.66KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base        24.76ms     28ms      26.9    31.4MB
#> 2 fastmatch    1.05µs    1.1µs  843729.         0B
```
...
#> 1 as.POSIXct   29.38µs  31.35µs    30856.        0B     0   
#> 2 as.POSIXlt   20.08µs  21.19µs    45942.        0B    46.0 
#> 3 ymd_hms       2.25ms   2.32ms      430.    21.5KB     3.47
#> 4 fastPOSIXct   1.18µs   1.23µs   770898.        0B     0
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 rowSums       822µs    1.3ms      781.     859KB
#> 2 .rowSums      818µs   1.29ms      779.     859KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.06ms   1.08ms      877.    1.57MB
#> 2 custom      683.9µs 707.94µs     1407.    1.12MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          616µs    639µs     1556.     960KB
#> 2 custom        341µs    352µs     2809.     484KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.08ms    1.1ms      894.    1.28MB
#> 2 custom     403.88µs  422.8µs     2355.  586.98KB
```
...
#>   expression                min   median `itr/sec` mem_alloc
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 crossprod(x, w)[[1]]    390ns    421ns  2237061.        0B
#> 2 sum(x * w)[[1]]         440ns    481ns  1887767.        0B
```
