...
#> 1 lm            866µs 903.82µs     1087.    1.25MB
#> 2 speedglm     1.06ms   1.19ms      776.   72.71MB
#> 3 biglm      793.61µs  827.6µs     1178.  589.44KB
#> 4 fastLm     988.38µs   1.02ms      970.    4.61MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.18µs   1.24µs   744908.     2.8KB
#> 2 fastmatch    1.06µs   1.11µs   856802.    2.66KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base        25.19ms   26.6ms      27.7    31.4MB
#> 2 fastmatch    1.06µs    1.1µs  859547.         0B
```
...
#> 1 as.POSIXct   29.82µs  31.69µs    30994.        0B     0   
#> 2 as.POSIXlt   20.03µs   21.2µs    45653.        0B    45.7 
#> 3 ymd_hms       2.24ms   2.31ms      433.    21.5KB     3.49
#> 4 fastPOSIXct   1.17µs   1.22µs   783206.        0B     0
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 rowSums       832µs   1.29ms      820.     859KB
#> 2 .rowSums      817µs    1.3ms      757.     859KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.06ms   1.07ms      890.    1.57MB
#> 2 custom     669.59µs 694.76µs     1430.    1.12MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          602µs    625µs     1591.     960KB
#> 2 custom        338µs    349µs     2838.     484KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.06ms   1.09ms      909.    1.28MB
#> 2 custom     404.11µs 422.13µs     2350.  586.98KB
```
...
#>   expression                min   median `itr/sec` mem_alloc
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 crossprod(x, w)[[1]]    370ns    411ns  2261956.        0B
#> 2 sum(x * w)[[1]]         440ns    481ns  1889279.        0B
```
