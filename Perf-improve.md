...
#> 1 lm         838.66µs 874.05µs     1122.    1.26MB
#> 2 speedglm     1.48ms   1.53ms      649.   70.75MB
#> 3 biglm      768.67µs 801.76µs     1185.  589.44KB
#> 4 fastLm     942.19µs    976µs     1021.    4.54MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.11µs   1.17µs   777264.     2.8KB
#> 2 fastmatch    1.04µs   1.09µs   872251.    2.66KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         22.3ms  22.56ms      44.4    31.4MB
#> 2 fastmatch    1.02µs   1.07µs  889278.         0B
```
...
#> 1 as.POSIXct   28.45µs  29.89µs    32477.        0B    32.5 
#> 2 as.POSIXlt   19.53µs  20.46µs    47410.        0B     0   
#> 3 ymd_hms       2.19ms   2.23ms      447.    21.5KB     7.73
#> 4 fastPOSIXct   1.16µs   1.21µs   764730.        0B     0
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 rowSums       838µs    1.3ms      772.     859KB
#> 2 .rowSums      837µs    1.3ms      769.     859KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          859µs    891µs     1090.    1.57MB
#> 2 custom        655µs    682µs     1458.    1.12MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          588µs    609µs     1624.     960KB
#> 2 custom        330µs    338µs     2924.     484KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          866µs    896µs     1098.    1.28MB
#> 2 custom        390µs    405µs     2433.  586.98KB
```
...
#>   expression                min   median `itr/sec` mem_alloc
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 crossprod(x, w)[[1]]    390ns    431ns  2169383.        0B
#> 2 sum(x * w)[[1]]         441ns    481ns  1896496.        0B
```
