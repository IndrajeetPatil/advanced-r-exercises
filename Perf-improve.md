...
#> 1 lm         844.92µs 906.37µs     1063.    1.26MB
#> 2 speedglm     1.46ms   1.54ms      647.   70.75MB
#> 3 biglm      717.03µs 801.29µs     1167.  589.44KB
#> 4 fastLm     903.11µs 979.78µs     1017.    4.54MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.17µs   1.24µs   747376.     2.8KB
#> 2 fastmatch    1.04µs   1.08µs   863926.    2.66KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base        21.38ms   21.9ms      44.3    31.4MB
#> 2 fastmatch    1.03µs   1.14µs  843440.         0B
```
...
#> 1 as.POSIXct   28.85µs  30.21µs    32065.        0B     0   
#> 2 as.POSIXlt   19.88µs  20.89µs    46802.        0B     0   
#> 3 ymd_hms       2.13ms   2.26ms      441.    21.5KB     5.35
#> 4 fastPOSIXct   1.21µs   1.27µs   721117.        0B     0
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 rowSums       831µs    1.3ms      739.     859KB
#> 2 .rowSums      817µs    1.3ms      752.     859KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          861µs    888µs     1081.    1.57MB
#> 2 custom        616µs    687µs     1453.    1.12MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          589µs    618µs     1611.     960KB
#> 2 custom        301µs    339µs     2922.     484KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          822µs    898µs     1104.    1.28MB
#> 2 custom        362µs    406µs     2446.  586.98KB
```
...
#>   expression                min   median `itr/sec` mem_alloc
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 crossprod(x, w)[[1]]    370ns    441ns  2119909.        0B
#> 2 sum(x * w)[[1]]         401ns    481ns  1924663.        0B
```
