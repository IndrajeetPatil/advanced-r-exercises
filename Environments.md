...
``` r
lobstr::ref(e$loop)
#> █ [1:0x5638983c71e8] <env> 
#> └─loop = [1:0x5638983c71e8]
```
...
#> [1] "0x56389abdbf50" "0x56389abdbf50"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x56389ac2b750" "0x56389ac2b750"
```
