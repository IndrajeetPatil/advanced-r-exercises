...
``` r
lobstr::ref(e$loop)
#> █ [1:0x56488e338730] <env> 
#> └─loop = [1:0x56488e338730]
```
...
#> [1] "0x564890b49620" "0x564890b49620"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x564890b9dc60" "0x564890b9dc60"
```
