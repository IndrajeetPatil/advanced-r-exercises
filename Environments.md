...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55879f838540] <env> 
#> └─loop = [1:0x55879f838540]
```
...
#> [1] "0x5587a1f4c130" "0x5587a1f4c130"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x5587a1f96940" "0x5587a1f96940"
```
