...
``` r
lobstr::ref(e$loop)
#> █ [1:0x558c06e841e8] <env> 
#> └─loop = [1:0x558c06e841e8]
```
...
#> [1] "0x558c09698f50" "0x558c09698f50"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x558c096e8750" "0x558c096e8750"
```
