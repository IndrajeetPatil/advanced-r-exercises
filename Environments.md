...
``` r
lobstr::ref(e$loop)
#> █ [1:0x557595aa4740] <env> 
#> └─loop = [1:0x557595aa4740]
```
...
#> [1] "0x5575982b81f8" "0x5575982b81f8"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x557598306458" "0x557598306458"
```
