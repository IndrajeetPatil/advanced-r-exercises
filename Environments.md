...
``` r
lobstr::ref(e$loop)
#> █ [1:0x56157f70dc78] <env> 
#> └─loop = [1:0x56157f70dc78]
```
...
#> [1] "0x561581b4d3e0" "0x561581b4d3e0"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x561581b9f9b0" "0x561581b9f9b0"
```
