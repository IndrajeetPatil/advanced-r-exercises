...
``` r
lobstr::ref(e$loop)
#> █ [1:0x561cd799fff0] <env> 
#> └─loop = [1:0x561cd799fff0]
```
...
#> [1] "0x561cda1b3938" "0x561cda1b3938"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x561cda207f78" "0x561cda207f78"
```
