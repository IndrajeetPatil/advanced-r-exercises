...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55587de03498] <env> 
#> └─loop = [1:0x55587de03498]
```
...
#> [1] "0x555880616400" "0x555880616400"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x555880666c10" "0x555880666c10"
```
