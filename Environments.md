...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55cbaaa9b4a8] <env> 
#> └─loop = [1:0x55cbaaa9b4a8]
```
...
#> [1] "0x55cbad2af2e0" "0x55cbad2af2e0"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55cbad2ffaf0" "0x55cbad2ffaf0"
```
