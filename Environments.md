...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55f34e0bc470] <env> 
#> └─loop = [1:0x55f34e0bc470]
```
...
#> [1] "0x55f3507d06d0" "0x55f3507d06d0"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55f35081aee0" "0x55f35081aee0"
```
