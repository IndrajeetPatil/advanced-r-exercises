...
``` r
lobstr::ref(e$loop)
#> █ [1:0x56511e5d7480] <env> 
#> └─loop = [1:0x56511e5d7480]
```
...
#> [1] "0x565120ceb6a0" "0x565120ceb6a0"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x565120d35eb0" "0x565120d35eb0"
```
