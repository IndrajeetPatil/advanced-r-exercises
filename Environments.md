...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55fe3b73b318] <env> 
#> └─loop = [1:0x55fe3b73b318]
```
...
#> [1] "0x55fe3dbaec28" "0x55fe3dbaec28"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55fe3dbff188" "0x55fe3dbff188"
```
...
#> [1] "package:stats"
#> attr(,"path")
#> [1] "/opt/R/4.4.3/lib/R/library/stats"
