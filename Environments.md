...
``` r
lobstr::ref(e$loop)
#> █ [1:0x5561613de1e8] <env> 
#> └─loop = [1:0x5561613de1e8]
```
...
#> [1] "0x556163bf2f50" "0x556163bf2f50"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x556163c42750" "0x556163c42750"
```
