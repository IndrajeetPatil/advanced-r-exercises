...
``` r
lobstr::ref(e$loop)
#> █ [1:0x561212bd66d0] <env> 
#> └─loop = [1:0x561212bd66d0]
```
...
#> [1] "0x5612153ea188" "0x5612153ea188"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x5612154383e8" "0x5612154383e8"
```
