...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55e5cef0b1e8] <env> 
#> └─loop = [1:0x55e5cef0b1e8]
```
...
#> [1] "0x55e5d171ecf0" "0x55e5d171ecf0"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55e5d176f500" "0x55e5d176f500"
```
