...
``` r
lobstr::ref(e$loop)
#> █ [1:0x5646b4171318] <env> 
#> └─loop = [1:0x5646b4171318]
```
...
#> [1] "0x5646b65e5508" "0x5646b65e5508"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x5646b6635a68" "0x5646b6635a68"
```
