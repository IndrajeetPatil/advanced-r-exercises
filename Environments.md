...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55db7eec87c8] <env> 
#> └─loop = [1:0x55db7eec87c8]
```
...
#> [1] "0x55db8133ceb8" "0x55db8133ceb8"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55db8138d418" "0x55db8138d418"
```
