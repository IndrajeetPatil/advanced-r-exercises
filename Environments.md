...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55f3cceb0480] <env> 
#> └─loop = [1:0x55f3cceb0480]
```
...
#> [1] "0x55f3cf5c4780" "0x55f3cf5c4780"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55f3cf60ef90" "0x55f3cf60ef90"
```
