...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55b722c2e318] <env> 
#> └─loop = [1:0x55b722c2e318]
```
...
#> [1] "0x55b7250a2508" "0x55b7250a2508"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55b7250f2a68" "0x55b7250f2a68"
```
