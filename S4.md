...
new("Empty")
#> Error in `new()`:
#> ! trying to generate an object from a virtual class ("Empty")
```
...
#> Error in `rematchDefinition()`:
#> ! methods can add arguments to the generic 'age' only if '...' is an argument to the generic
...
<img src="https://raw.githubusercontent.com/Tazinho/Advanced-R-Solutions/main/images/s4/method_dispatch1.png" alt="" width="100%" />
...
<img src="https://raw.githubusercontent.com/Tazinho/Advanced-R-Solutions/main/images/s4/method_dispatch2.png" alt="" width="100%" />
