...
#> Error:
#> ! All list elements in `x` should have same length.

new_data_frame(list("x" = 1, "y" = c(2)), row.names = 1L)
#> Error:
#> ! Row name should be of `chracter` type.
...
#> ! non-numeric-alike variable(s) in data frame: y
```
